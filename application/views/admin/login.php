...
<html>
<head>
	<title><?php echo $setn['web_name'];?></title>
      ...
      <div class="card-body">
       <div class="card-content p-2">
        <div class="text-center">
          <img height="50" width="50" src="<?php echo base_url().'assets/img/'.$setn['web_logo']; ?>"/>
        </div>
        <div class="card-title text-uppercase text-center py-2 text-white"><?php echo $setn['web_name'];?></div>
...
<script type="text/javascript">
  ...
  function login_ajax(){
    ...
    if(email == '') {
      ...
      $.ajax({
        type: 'post',
        url: '<?php  header('Access-Control-Allow-Origin: *'); echo base_url() ?>login/adminlogin',
        data: dataString,
        dataType: 'json', 
        success: function (data) {
          if(jQuery.trim(data)=='100') {
            window.location.replace("<?php echo base_url() ?>asakdk/dashboard");
          }else{
